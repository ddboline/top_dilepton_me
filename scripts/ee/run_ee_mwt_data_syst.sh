...
# nohup sh top_dilepton_me/scripts/ee/run_ee_mwt_data_syst.sh > cafe_ee_data_syst.out 2> cafe_ee_data_syst.err &
# nohup sh top_dilepton_me/scripts/emu/run_emu_mwt_data_syst.sh > cafe_emu_data_syst.out 2> cafe_emu_data_syst.err &
# nohup sh top_dilepton_me/scripts/mumu/run_mumu_mwt_data_syst.sh > cafe_mumu_data_syst.out 2> cafe_mumu_data_syst.err &
# nohup sh top_dilepton_me/scripts/etrk/run_etrk_mwt_data_syst.sh > cafe_etrk_data_syst.out 2> cafe_etrk_data_syst.err &
# nohup sh top_dilepton_me/scripts/mutrk/run_mutrk_mwt_data_syst.sh > cafe_mutrk_data_syst.out 2> cafe_mutrk_data_syst.err &
# nohup sh top_dilepton_me/scripts/run_comb_mwt_data_syst.sh > cafe_comb_data_syst.out 2> cafe_comb_data_syst.err &
