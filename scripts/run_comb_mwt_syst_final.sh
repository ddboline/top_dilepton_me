...
RCP="-rcp=top_dilepton_me/rcp/mwt_wmt_comb.rcp"
NPERENS=40
...
for SYSTEMATIC in "lumi,lumi" "alp_signal,color_recomb_dw" "bjesn_migration,bjesp_migration" "jesn_migration,jesp_migration" "btagbp,btagbn" "btagcp,btagcn" "btaglp,btagln" "gluonradn,gluonradp" "bfragn,bfragp" "bfragbn,bfragbp" "bfragcn,bfragcp" "emcorrn,emcorrp" "emcorr_preseln,emcorr_preselp" "muonidn,muonidp" "muonison,muonisop" "muontrackn,muontrackp" "tracktrackn,tracktrackp" "sb_up_ee,sb_down_ee" "sb_up_emu,sb_down_emu" "sb_up_mumu,sb_down_mumu" "sb_up_etrk,sb_down_etrk" "sb_up_mutrk,sb_down_mutrk" "pyt_bkg_ee,pyt_bkg_emu"  "pyt_bkg_emu,pyt_bkg_mumu" "pyt_bkg_etrk,pyt_bkg_mutrk" "triggern_ee,triggerp_ee" "triggern_emu,triggerp_emu" "triggern_mumu,triggerp_mumu" "triggern_etrk,triggerp_etrk" "triggern_mutrk,triggerp_mutrk";
do 
