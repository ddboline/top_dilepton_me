...
# COMMAND=" cafe"
COMMAND="echo runme -cabsrv1 -cput=${TIME} -mem=${MEM} -outdir=/rooms/snapper/projects/ddboline/results_mwt/mwt_weights/etrk -tar=/rooms/snapper/projects/ddboline/me_p18.10.00.tar.gz"
