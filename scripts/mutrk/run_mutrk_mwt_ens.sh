...
# COMMAND=" cafe"
COMMAND="echo runme -cabsrv1 -cput=${TIME} -mem=${MEM} -outdir=/rooms/snapper/projects/ddboline/results_mwt/mwt_weights/mutrk -tar=/rooms/snapper/projects/ddboline/me_p18.10.00.tar.gz"
COMMAND=" ./top_dilepton_me/bin/top_dilepton_me_x"

RCP="-rcp=top_dilepton_me/rcp/mutrk/mwt_wmt_mutrk.rcp"
NPERENS=40
